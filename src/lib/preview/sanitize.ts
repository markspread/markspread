...
const ALLOWED_ATTRS: Record<string, Set<string>> = {
  "*": new Set(["id", "class", "title", "lang", "dir", "data-task-line", "data-language", "aria-label", "aria-hidden", "role"]),
  ...
  text: new Set(["x", "y", "dx", "dy", "fill", "transform", "text-anchor", "font-size", "font-family"]),
