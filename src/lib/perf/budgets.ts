...
export const PERF_BUDGETS: PerfBudget[] = [
  ...
  {
    id: "cold-start.macos-aarch64",
    description: "Cold start on Apple Silicon",
    target: 350,
    ceiling: 500,
    unit: "ms",
    source: "renderer",
  ...
  {
    id: "cold-start.macos-x86",
    description: "Cold start on Intel Mac",
    target: 600,
    ceiling: 900,
    unit: "ms",
    source: "renderer",
  ...
  {
    id: "cold-start.windows",
    description: "Cold start on Windows 11 x86_64",
    target: 600,
    ceiling: 1000,
    unit: "ms",
    source: "renderer",
  ...
  {
    id: "cold-start.linux",
    description: "Cold start on Ubuntu 22.04",
    target: 500,
    ceiling: 800,
    unit: "ms",
    source: "renderer",
  ...
  {
    id: "open-1mb",
    description: "Open 1MB markdown file",
    target: 60,
    ceiling: 100,
    unit: "ms",
    source: "renderer",
  ...
  {
    id: "open-10mb",
    description: "Open 10MB markdown file",
    target: 300,
    ceiling: 500,
    unit: "ms",
    source: "renderer",
  ...
  {
    id: "open-50mb",
    description: "Open 50MB markdown file (partial load + warning)",
    target: 1000,
    ceiling: 2000,
    unit: "ms",
    source: "renderer",
  ...
  {
    id: "index.100mb-files",
    description: "Index 100MB workspace",
    target: 3500,
    ceiling: 5000,
    unit: "ms",
    source: "rust",
  ...
  {
    id: "index.10k-files",
    description: "Index 10,000 files",
    target: 20000,
    ceiling: 30000,
    unit: "ms",
    source: "rust",
  ...
  {
    id: "index.100k-files",
    description: "Index 100,000 files",
    target: 200000,
    ceiling: 300000,
    unit: "ms",
    source: "rust",
  ...
  {
    id: "rss.idle",
    description: "Idle resident memory",
    target: 60,
    ceiling: 80,
    unit: "MB",
    source: "rust",
  ...
  {
    id: "rss.workspace-10k-files",
    description: "Resident memory with 10K-file workspace open",
    target: 200,
    ceiling: 250,
    unit: "MB",
    source: "rust",
  ...
  {
    id: "bundle.dmg",
    description: "macOS .dmg installer size",
    target: 12,
    ceiling: 15,
    unit: "MB",
    source: "ci-script",
  ...
  {
    id: "bundle.msi",
    description: "Windows .msi installer size",
    target: 12,
    ceiling: 15,
    unit: "MB",
    source: "ci-script",
  ...
  {
    id: "input.keystroke",
    description: "Time from keypress to caret move",
    target: 8,
    ceiling: 16,
    unit: "ms",
    source: "renderer",
  ...
  {
    id: "search.10k-files",
    description: "Workspace search across 10K files",
    target: 600,
    ceiling: 1000,
    unit: "ms",
    source: "rust",
  ...
  {
    id: "completion.local",
    description: "Autocomplete first suggestion latency",
    target: 25,
    ceiling: 50,
    unit: "ms",
    source: "renderer",
  ...
  {
    id: "preview.debounce",
    description: "Markdown preview debounce window",
    target: 80,
    ceiling: 120,
    unit: "ms",
    source: "renderer",
  ...
  {
    id: "panes.1.input-keystroke-p95",
    description: "Keystroke p95 with 1 pane",
    target: 10,
    ceiling: 16,
    unit: "ms",
    source: "renderer",
  ...
  {
    id: "panes.2.input-keystroke-p95",
    description: "Keystroke p95 with 2 panes",
    target: 12,
    ceiling: 16,
    unit: "ms",
    source: "renderer",
  ...
  {
    id: "panes.4.input-keystroke-p95",
    description: "Keystroke p95 with 4 panes",
    target: 14,
    ceiling: 16,
    unit: "ms",
    source: "renderer",
  ...
  {
    id: "panes.1.rss-idle",
    description: "Idle resident memory with 1 pane",
    target: 60,
    ceiling: 80,
    unit: "MB",
    source: "rust",
  ...
  {
    id: "panes.2.rss-idle",
    description: "Idle resident memory with 2 panes",
    target: 75,
    ceiling: 100,
    unit: "MB",
    source: "rust",
  ...
  {
    id: "panes.4.rss-idle",
    description: "Idle resident memory with 4 panes",
    target: 110,
    ceiling: 150,
    unit: "MB",
    source: "rust",
  ...
  {
    id: "panes.1.cold-start",
    description: "Cold start with 1 pane restored",
    target: 350,
    ceiling: 500,
    unit: "ms",
    source: "renderer",
  ...
  {
    id: "panes.2.cold-start",
    description: "Cold start with 2 panes restored",
    target: 420,
    ceiling: 650,
    unit: "ms",
    source: "renderer",
  ...
  {
    id: "panes.4.cold-start",
    description: "Cold start with 4 panes restored",
    target: 550,
    ceiling: 900,
    unit: "ms",
    source: "renderer",
